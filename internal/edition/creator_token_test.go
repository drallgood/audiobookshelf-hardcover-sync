...
func TestCreatorAudiobookshelfTokenScoping(t *testing.T) {
	...
	tests := []struct {
		...
		{"plain traversal outside path withheld", "https://example.com/abs", "https://example.com/abs/../admin/cover.jpg", false},
		{"encoded dot traversal outside path withheld", "https://example.com/abs", "https://example.com/abs/%2e%2e/admin/cover.jpg", false},
		{"encoded slash traversal outside path withheld", "https://example.com/abs", "https://example.com/abs/%2f../admin/cover.jpg", false},
		...
		{"unset base keeps legacy match", "", "https://audiobookshelf.example.com/api/items/li_1/cover", true},
