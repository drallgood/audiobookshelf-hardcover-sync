...
- **Hyphenated ISBNs are kept**: An Audiobookshelf ISBN written with hyphens or spaces was dropped from the mismatch export, because ISBN-10 and ISBN-13 were told apart by exact string length. It is now normalized before it is split into ISBN-10 or ISBN-13. By @Snuffy2.
