...
- **Book links in sync details**: Book titles in every outcome category now open the corresponding Audiobookshelf item in a new tab. Records with a known Hardcover match also show a consistent Hardcover link.
