...
- [Hardcover API token](#getting-started) (requires scopes: `read:library`, `read:catalog`, `read:lists`, `write:library` — [create one with this link](https://hardcover.app/account/api/keys/new?scope=read%3Alibrary+read%3Acatalog+write%3Alibrary+read%3Alists))
